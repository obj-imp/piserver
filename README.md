...
- SMB1/NT1 and LANMAN/NTLM authentication are enabled globally so DOS can negotiate. Modern OSes still prefer SMB2/3 automatically, but the Pi should remain on an isolated, trusted network segment.
